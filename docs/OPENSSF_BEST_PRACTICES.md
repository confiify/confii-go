...
| `two_person_review` | The 2026-07-25 ledger records 6 qualifying independently reviewed PRs among 20 non-trivial merged PRs. | Public history demonstrates that another person reviewed at least 50% of non-trivial changes before acceptance. |
...
This establishes 6 qualifying reviews among 20 non-trivial merged PRs. If
every subsequent PR qualifies, 8 additional substantive reviewed PRs are
needed to reach 50%: `(6 + 8) / (20 + 8) = 50%`. This is a planning baseline,
